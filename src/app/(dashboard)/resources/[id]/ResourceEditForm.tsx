...
export default function ResourceEditForm({ resource }: Props) {
  ...
  async function handleImageUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      formData.append("prefix", "resources");
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">資料を編集</h1>
        </div>
        <span
      ...
      <div className="flex items-center justify-between">
        ...
        >
          ...
          {deleting ? "削除中..." : "この資料を削除"}
        </button>
        <div className="flex items-center gap-3">
          <Link href="/resources" className="text-sm text-gray-500 hover:text-gray-700">キャンセル</Link>
          <button
            onClick={handleSave}
